# 1 "c:\\users\\nick\\desktop\\repository2\\scripts\\uc_checkitinerary\\\\combined_UC_CheckItinerary.c"
...
# 1 "c:\\users\\nick\\desktop\\repository2\\scripts\\uc_checkitinerary\\\\combined_UC_CheckItinerary.c" 2
...
web_reg_find("Text=Web Tours",
	...
	lr_end_transaction("checkItinerary",2);

	lr_think_time(23);

	logout();

	lr_end_transaction("UC2_CheckItinerary", 2);
