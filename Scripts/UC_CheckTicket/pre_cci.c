# 1 "c:\\users\\nick\\desktop\\repository2\\scripts\\uc_checkticket\\\\combined_UC_CheckTicket.c"
...
# 1 "c:\\users\\nick\\desktop\\repository2\\scripts\\uc_checkticket\\\\combined_UC_CheckTicket.c" 2
...
Action()
{
	...
	lr_end_transaction("fellFlightsData",2);
	...
	lr_end_transaction("checkFlights",2);

	logout();
	
	lr_end_transaction("UC_CheckTicket", 2);
